...
func getUserBest(user: User, songname: String, difficulty: Difficulty, retry: Int = 5, completion: @escaping (Result<UserBestPlayResponse, APIError>) -> Void) {
    var urlParams = [
        "songname": songname,
...
func getUserInfo(user: User, recent: Int = 0, retry: Int = 5, completion: @escaping (Result<UserInfoResponse, APIError>) -> Void) {
    var urlParams = [
        "recent": "\(recent)",
    ]
